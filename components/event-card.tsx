...
export function EventCard({ event }: EventCardProps) {
  const cardContent = (
    <div 
      className="group flex flex-col bg-surface border border-border rounded-xl hover:shadow-card hover:border-border-hover hover:-translate-y-1 transition-all h-full overflow-hidden"
    >
      {event.imageUrl && (
